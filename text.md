# Depa — Seed round source copy

Working narrative for deck slides. Edit here first, then reflect in `current version/index.html`.
...
Depa is raising its **seed round** to scale from PSP traction into the operating core for regulated money businesses.
